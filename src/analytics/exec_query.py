...
def main():
    ...
    parser.add_argument('--target', choices=['analytics'], default='analytics')
    parser.add_argument('--table', type=str, help='Tabela que será processada com o mesmo nome do arquivo.')
    parser.add_argument('--start', type=str, default='2024-03-01', help='Data de início no formato aaaa-mm-dd.')
    ...
    exec_query(args.table, args.db_origin, args.target, args.start, args.stop, args.monthly)
